...
create table powersupplytypes(
id int not null primary key identity(1,1),
name varchar(100) not null,
);

create table instalationtypes(
id int not null primary key identity(1,1),
name varchar(100) not null,
);
...
alter table location add foreign key (instalation_type) references instalationtypes(id);
alter table location add foreign key (power_supply_type) references powersupplytypes(id);
...
('0104', 'Zelina', 6, 1),
('0106', 'Aspergeri', 7, 1),
('0107', 'Klinča Sela', 6, 2),
('0109', 'Lučko', 7, 1),
('0110', 'Dugo selo', 7, 1),
('0112', 'Okešinec', 6, 2),
('0116', 'Gornji Čehi', 7, 2),
...
('0175', 'Kurilovec', 6, 2),
('0177', 'Kobilići', 6, 2),
('0196', 'Kljuc Brdovećki', 4, 2),
('0228', 'Ivanja Reka 3', 7, 2),
('0362', 'Kašina jug', 6, 1),
('0363', 'Adamovec', 7, 2),
('0368', 'Donja Zelina', 4, 2),
('0556', 'Kobiljak macro', 8, 3),
('1037', 'Hum Breznički', 6, 2),
('1044', 'Presečno', 6, 1),
('1055', 'Ivanec', 6, 1),
('1057', 'Čakovec 5 industrial', 3, 2),
('1060', 'Ludbreg', 7, 2),
('1082', 'Novi Marof', 6, 1),
('1089', 'Sveti Ðurđ Ludbreški', 6, 2),
('1101', 'Virje', 6, 2),
('1113', 'Habijanci', 7, 1),
('1114', 'Gradec', 2, 2),
('1118', 'Kloštar Vojakovački', 6, 2),
('1120', 'Rovišče Predavec', 7, 2),
